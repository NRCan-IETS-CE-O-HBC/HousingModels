...
# actuates the air point in main.
  ...
  100000.000 100000.000 20.000 22.000 33.5 32.5
    0   10   14.000  # ctl type, law (separate ON/OFF flux), start @
      6.  # No. of data items
  100000.000 100000.000 20.000 22.000 30.5 29.5
    0   10   15.000  # ctl type, law (separate ON/OFF flux), start @
      6.  # No. of data items
  100000.000 100000.000 20.000 22.000 27.5 26.5
    0   10   15.900  # ctl type, law (separate ON/OFF flux), start @
      6.  # No. of data items
  100000.000 100000.000 20.000 22.000 23.5 22.5
...
# actuates the air point in second.
  ...
  100000.000 100000.000 20.000 22.000 23.5 22.5
    0   10  7.000  # ctl type, law (separate ON/OFF flux), start @
      6.  # No. of data items
  100000.000 100000.000 20.000 22.000 33.5 32.5
    0   10  20.000  # ctl type, law (separate ON/OFF flux), start @
      6.  # No. of data items
  100000.000 100000.000 20.000 22.000 23.5 22.5
* Control function
