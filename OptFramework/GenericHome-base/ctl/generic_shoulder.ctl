...
# actuates the air point in first_fl.
    ...
    0    1   0.000  # ctl type, law (basic control), start @
      7.  # No. of data items
   <OPT-heat-cool-cap> 0.000 0.000 0.000 21.000 100.000 0.000
  106  166  # valid April 16 - June 15th Shoulder
     1  # No. of periods in day: sunday      
    0    1   0.000  # ctl type, law (basic control), start @
      7.  # No. of data items
   <OPT-heat-cool-cap> 0.000 <OPT-heat-cool-cap> 0.000 18.000 26.000 0.000 
  167  243  # valid June 16th to Aug 31st Cooling
     1  # No. of periods in day: saturday    
    0    1   0.000  # ctl type, law (basic control), start @
      7.  # No. of data items
  0.000 0.000 <OPT-heat-cool-cap> 0.000 -20.000 25.000 0.000
...
# actuates the air point in bsmt.
  ...
  106  166  # valid April 16 - June 15th Shoulder
    ...
    0   21   0.000  # ctl type, law (slave capacity controller), start @
      3.  # No. of data items
  1.000 <OPT-heat-cool-cap> <OPT-heat-cool-cap> 
  167  243  # valid June 16th to Aug 31st Cooling
     1  # No. of periods in day: saturday    
    0   21   0.000  # ctl type, law (slave capacity controller), start @
      3.  # No. of data items
