control for MB-LEEP  # overall descr 
* Building
...
7  # No. of data items
17426.965 0.000 0.000 0.000 22.000 100.000 0.000   # MaxHCap/MinHCap/MaxCCap/MinCCap/HStPt/CStPt/ClTRng
# ++++++ Day Type: 2 +++++
...
3  # No. of data items
1.000 4573.036 0.000   # MasterCtlFnc/MaxHCap/MaxCCap
# END  Control Function   # 2
* Control Function # 3[L2Z3CoreAttic] 
...
* Control Function # 4[L2Z4FrontGarage] 
# senses the temperature of the current zone.
    0    0    0    0    0  # sensor data
# actuates air point of the current zone
    0    0    0    0  # actuator data
