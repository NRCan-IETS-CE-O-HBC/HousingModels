Instructions for modelling 3-storey attached homes
1. Determine the geometry tags using 3storey_model_geometry.xlsx (in this directory).
...
3. Update DESIGN-generic-3storey.choices
