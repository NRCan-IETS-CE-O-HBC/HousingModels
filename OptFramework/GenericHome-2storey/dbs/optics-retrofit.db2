...
# 12 char id |  description       | thick | blind
DBLLowE       :double glazing with low-e 0.2
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
  1   3  0.613  0.240  0.110  1.73
# direct trn @ 5 angles, total heat gain @ 5 angles
  0.624 0.602 0.545 0.385 0.186 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
  1.520 0.095 0.105 0.115 0.129 0.135
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.135 0.137 0.130 0.109 0.064
# 12 char id |  description       | thick | blind
Tpl-2coats    :Triple-pane argon + low-e
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
  1   5  0.640  0.070  0.110  0.970
# direct trn @ 5 angles, total heat gain @ 5 angles
  0.456 0.433 0.377 0.235 0.096 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
  1.520 0.102 0.112 0.123 0.137 0.138
  1.000 0.001 0.001 0.001 0.001 0.001
...
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   5  0.590  0.075  0.110  1.774
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.152 0.143 0.123 0.075 0.030 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.### 
  1.520 0.123 0.134 0.144 0.156 0.150
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.085 0.090 0.091 0.084 0.061
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.059 0.060 0.056 0.042 0.021
Win2scLE1_tr
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   5  0.429  0.075  0.110  1.357
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.199 0.185 0.157 0.094 0.035 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.148 0.158 0.165 0.169 0.154
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.121 0.126 0.124 0.109 0.071
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.081 0.084 0.080 0.066 0.033
Win3hcLE1_tr
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   5  0.468 0.075  0.110  1.447
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.305 0.286 0.246 0.153 0.059 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.126 0.137 0.147 0.158 0.151
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.088 0.093 0.094 0.087 0.063
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.089 0.085 0.075 0.052 0.022
Win4scLE2_tr
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   5  0.366 0.075  0.110  1.192
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.153 0.14 0.116 0.063 0.022 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.171 0.184 0.193 0.194 0.172
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.114 0.12 0.12 0.113 0.074
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.054 0.056 0.052 0.041 0.02
Win5hcLE2_tr
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   5  0.435 0.075  0.110  1.289
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.275 0.259 0.225 0.139 0.056 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.127 0.139 0.149 0.162 0.155
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.127 0.126 0.119 0.101 0.061
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.070 0.069 0.061 0.043 0.020
Win6_qd_CL
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   7  0.477 0.075  0.110  1.527
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.346 0.322 0.268 0.154 0.051 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.074 0.081 0.089 0.100 0.100
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.057 0.061 0.064 0.063 0.051
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.045 0.047 0.046 0.040 0.025
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.061 0.061 0.056 0.038 0.017
Win7scle1_qd
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   7  0.406 0.075  0.110  1.262
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.193 0.178 0.148 0.083 0.028 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.088 0.094 0.1 0.106 0.102
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.075 0.08 0.081 0.075 0.054
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.068 0.071 0.069 0.057 0.033
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.081 0.083 0.078 0.059 0.027
Win8hcle1_qd
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   7  0.444 0.075  0.110  1.327
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.299 0.281 0.236 0.136 0.047 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.074 0.082 0.090 0.100 0.100
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.058 0.063 0.066 0.065 0.051
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.046 0.048 0.048 0.042 0.026
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.090 0.087 0.074 0.048 0.018
Win9scle2_qd
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   7  0.339 0.075  0.110  1.139
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.143 0.128 0.103 0.052 0.015 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.094 0.102 0.107 0.111 0.104
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.084 0.090 0.091 0.084 0.061
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.106 0.111 0.107 0.092 0.051
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.050 0.052 0.047 0.034 0.014
Win10hcle2_q
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
# 1   2  3.###  4.###  5.###  6.###
  1   7  0.406 0.075  0.110  1.209
# direct trn @ 5 angles, total heat gain @ 5 angles
# 1.### 2.### 3.### 4.### 5.### 6.### 7.### 8.### 9.### 0.###
  0.254 0.238 0.201 0.113 0.039 0.200 0.200 0.200 0.200 0.200
# refr index, absorption @ 5 angles for each tmc layer
# 0.### 1.### 2.### 3.### 4.### 5.###  
  1.520 0.074 0.082 0.090 0.100 0.100
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.059 0.063 0.066 0.065 0.052
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.116 0.114 0.105 0.080 0.040
  1.000 0.001 0.001 0.001 0.001 0.001
  1.520 0.064 0.062 0.054 0.035 0.014
# 12 char id |  description       | thick | blind
DblClr        :Double clear, air
# def lyr, tmc lyr, vis trn, sol refl, sol absor, U val
  1   3  0.800  0.120  0.210  2.800
# direct trn @ 5 angles, total heat gain @ 5 angles
  0.676 0.651 0.604 0.441 0.201 0.749 0.731 0.687 0.520 0.265
