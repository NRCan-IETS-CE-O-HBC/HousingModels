...
<!-- Energy flows section -->
    ...
    <!-- Months -->
    <xsl:apply-templates select="/system/building/month" mode="month_header" />
...
<!-- Temperatures -->
    ...
    <xsl:apply-templates select="//*[units='(ACH)' or
                                     units='(-)' ]"
                         mode="misc_data" />
  ...
  <xsl:template match="*" mode="monthly_watts_bin" >
      ...
      <xsl:apply-templates select="." mode="list_path" />
      <xsl:text>, </xsl:text>
  ...
  <xsl:template match="*" mode="monthly_efficiencies" >
      ...
      <xsl:value-of select="." mode="list_path" />
      <xsl:text>, </xsl:text>
  ...
  <!-- Month header -->
  <xsl:template match="*" mode="month_header">
  ...
  <xsl:template match="*" mode="list_path">
