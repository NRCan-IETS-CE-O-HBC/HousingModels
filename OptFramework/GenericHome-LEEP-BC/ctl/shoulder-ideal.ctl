...
# actuates the air point in first_fl.
    ...
    0    27   0.000  # ctl type, law (basic control), start @
      7.  # No. of data items
   15000. 0.000 0.000 0.000 <Opt-CtlWinterHeating> <Opt-CtlWinterCooling> 5.000
  106  166  # valid April 16 - June 15th Shoulder
     1  # No. of periods in day: sunday      
    0    27  0.000  # ctl type, law (basic control), start @
      7.  # No. of data items
   15000. 0.000 5000. 0.000 <Opt-CtlShoulderHeating> <Opt-CtlShoulderCooling> 5.000 
  167  243  # valid June 16th to Aug 31st Cooling
     1  # No. of periods in day: saturday    
    0    27   0.000  # ctl type, law (basic control), start @
      7.  # No. of data items
  0.000 0.000 5000. 0.000 <Opt-CtlSummerHeating> <Opt-CtlSummerCooling> 5.000
