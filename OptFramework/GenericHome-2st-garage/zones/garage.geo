...
*vertex,<gar-width>,0.00000,2.43840  #   2
*vertex,<gar-width>,<gar-length>,2.43840  #   3
*vertex,0.00000,<gar-length>,2.43840  #   4
*vertex,0.00000,0.00000,5.4864  #   5
*vertex,<gar-width>,0.00000,5.4864  #   6
*vertex,<gar-width>,<gar-length>,5.4864  #   7
...
*surf,Wall-1-gar,VERT,-,-,-,ex_brk,OPAQUE,EXTERIOR,0,0  #   1 ||< external
*surf,Wall-2-gar,VERT,-,-,-,<Opt-MainWall-Dry>R,OPAQUE,ANOTHER,02,08  #   2 ||< side-gar-1:first_fl
*surf,Wall-3-gar,VERT,-,-,-,<Opt-MainWall-Dry>R,OPAQUE,ANOTHER,02,07  #   3 ||< back-gar-1:first_fl
*surf,Wall-4-gar,VERT,-,-,-,ex_brk,OPAQUE,ADIABATIC,0,0  #   4 ||< adiabatic
*surf,top-gar,CEIL,-,-,-,<Opt-ExposedFloor>,OPAQUE,ANOTHER,03,11  #   5 ||< Top-9:second_fl
